...
public:
    ...
    void addSensor(uint8_t type);
    void setSensorValue(uint8_t adr, int32_t value);
    void setSensorValueFP(uint8_t adr, float value);
    uint16_t gpsStateValues(uint8_t firstVal, uint8_t secondVal);
